...
#find /home/servidor/samba/data/compartilhados -type f -newermt "$DATA" -print0 | tar --null --files-from=- --no-recursion -czvf /home/servidor/samba/bk_diario/$(date +%d%m%y)_backup_diario.tar.gz

find /home/servidor/samba/data/compartilhados -type f -newermt "$DATA" -print0 | tar --null -czvf /home/servidor/samba/bk_diario/$(date +%d%m%y)_backup_diario.tar.gz --files-from=-
